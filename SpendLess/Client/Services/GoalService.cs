...
namespace SpendLess.Client.Services
{
	public class GoalService : IGoalService
	{
		...
		public async Task GetGoals(Services.LogException logException)
		{
		...
		public async Task AddGoal(int userId, string name, double? amount, DateTime endDate)
		{
			...
			try
			{
				...
				var goal = new Goal(0, userId, name, amount, endDate);
